...
export default function CGUScreen() {
  ...
  useEffect(() => {
    if (__DEV__) {
      console.log('[CGU] Page CGU loaded - Date: 2026-01-21');
    }
  }, []);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
        ...
        <Text variant="caption" style={styles.version}>Date d'entrée en vigueur : 21 janvier 2026{'\n'}Version mise à jour : {new Date().toISOString()}</Text>
